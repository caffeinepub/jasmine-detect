...
function Layout({ children }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "bg-card border-b border-border shadow-subtle sticky top-0 z-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto px-4 py-3 flex items-center gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-md bg-primary flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "svg",
        {
          width: "18",
          height: "18",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-base font-display font-semibold text-foreground leading-tight", children: "Jasmine Detect" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground leading-tight", children: "Maturity stage analysis" })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 flex flex-col", children }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-muted/40 border-t border-border py-3 px-4 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
      "© ",
      year,
      ".",
      " ",
...
function simulateDetection(imageDataUrl) {
  return new Promise((resolve) => {
    setTimeout(() => {
      const hash = imageDataUrl.length % 7;
      const stages = ["small_bud", "big_bud", "bloom"];
      const count = 2 + hash % 3;
      const results = [];
      for (let i = 0; i < count; i++) {
        const stage = stages[i % stages.length];
        const col = i % 3;
        const x2 = 0.08 + col * 0.3 + hash % 3 * 0.02;
...
function useDetection() {
  const [screen, setScreen] = reactExports.useState("capture");
  const [imageDataUrl, setImageDataUrl] = reactExports.useState(null);
  const [imageMimeType, setImageMimeType] = reactExports.useState("image/jpeg");
  ...
  const setImageFromFile = reactExports.useCallback((file) => {
    setError(null);
    setDetections([]);
  ...
  const setImageFromDataUrl = reactExports.useCallback(
  ...
  const analyzeImage = reactExports.useCallback(async () => {
...
function AnnotationCanvas({ imageUrl, detections }) {
  const containerRef = reactExports.useRef(null);
  const canvasRef = reactExports.useRef(null);
  const [imgNaturalSize, setImgNaturalSize] = reactExports.useState({ w: 1, h: 1 });
  const draw = reactExports.useCallback(() => {
    ...
    for (const det of detections) {
      const { x: x2, y, width, height } = det.boundingBox;
      const colors = STAGE_COLORS[det.stage];
      const bx = offsetX + x2 * drawW;
      ...
      ctx.beginPath();
      ctx.moveTo(rx + r2, ry);
      ctx.lineTo(rx + rw - r2, ry);
      ctx.quadraticCurveTo(rx + rw, ry, rx + rw, ry + r2);
      ctx.lineTo(rx + rw, ry + rh - r2);
      ctx.quadraticCurveTo(rx + rw, ry + rh, rx + rw - r2, ry + rh);
      ctx.lineTo(rx + r2, ry + rh);
      ctx.quadraticCurveTo(rx, ry + rh, rx, ry + rh - r2);
      ctx.lineTo(rx, ry + r2);
      ctx.quadraticCurveTo(rx, ry, rx + r2, ry);
      ctx.closePath();
      ctx.fill();
      ctx.stroke();
...
function CameraModal({ onCapture, onClose }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "dialog",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-lg shadow-elevated w-full max-w-sm overflow-hidden border border-border", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-4 py-3 border-b border-border", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-semibold text-sm text-foreground", children: "Camera" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-[4/3] bg-muted relative", children: cameraError ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-center justify-center text-center px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: cameraError }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
          "video",
          {
            ref: videoRef,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-3 flex gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              type: "button",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Camera, { className: "w-4 h-4 mr-1.5" }),
                "Capture"
              ]
            }
          )
...
function HomePage() {
  ...
  const newFileInputRef = reactExports.useRef(null);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 flex flex-col items-center justify-start py-6 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-xl space-y-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            hasImage ? isResults && detections.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
              AnnotationCanvas,
              {
            ...
            ) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center py-16 px-6 text-center gap-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-full bg-muted flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "svg",
                {
                  width: "32",
                  height: "32",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-foreground text-sm", children: "No flower selected" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "Upload a photo or use your camera to capture jasmine flowers" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 flex-wrap justify-center", children: ["small_bud", "big_bud", "bloom"].map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(StagePill, { stage: s }, s)) })
            ] }),
            isAnalyzing && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(ScanLine, { className: "w-8 h-8 text-primary animate-pulse" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground", children: "Analyzing flowers…" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-40 h-1 bg-muted rounded-full overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full bg-primary rounded-full w-3/5" }) })
                ] })
              }
            )
          ]
      ...
      isResults && detections.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm font-semibold font-display text-foreground", children: [
                detections.length,
                " flower",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2 mb-3", children: Object.entries(summaryByStage).map(([stage, count]) => {
              var _a2, _b2, _c2, _d2;
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "span",
                {
                  ...
                  style: {
                    borderColor: (_a2 = STAGE_COLORS[stage]) == null ? void 0 : _a2.stroke,
                    backgroundColor: (_b2 = STAGE_COLORS[stage]) == null ? void 0 : _b2.bg,
                    color: (_c2 = STAGE_COLORS[stage]) == null ? void 0 : _c2.text
                  },
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                        ...
                        style: {
                          backgroundColor: (_d2 = STAGE_COLORS[stage]) == null ? void 0 : _d2.stroke
                        }
                      }
                    ),
                    STAGE_LABELS[stage],
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1.5", children: detections.map((det, i) => {
              var _a2, _b2, _c2, _d2;
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  style: {
                    borderColor: (_a2 = STAGE_COLORS[det.stage]) == null ? void 0 : _a2.stroke,
                    backgroundColor: (_b2 = STAGE_COLORS[det.stage]) == null ? void 0 : _b2.bg
                  },
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                        ...
                        style: { color: (_c2 = STAGE_COLORS[det.stage]) == null ? void 0 : _c2.text },
                        children: STAGE_LABELS[det.stage]
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "span",
                      {
                        ...
                        style: { color: (_d2 = STAGE_COLORS[det.stage]) == null ? void 0 : _d2.stroke },
                        children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-3", children: "Confidence scale: ≥90% high · 80–89% medium · 70–79% low · <70% uncertain" })
          ]
        }
      ),
      !isResults && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", "data-ocid": "capture-actions", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            type: "button",
      ...
      hasImage && !isResults && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(ScanLine, { className: "w-4 h-4 mr-2" }),
      ...
      isResults && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-2", "data-ocid": "results-actions", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            type: "button",
            ...
            onClick: () => {
              var _a2;
              return (_a2 = newFileInputRef.current) == null ? void 0 : _a2.click();
            },
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(HomePage, {}),
